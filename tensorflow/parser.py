...
class ParseArgs():
	...
	def assign_args(self):
		...
		try:
			...
			raise ValueError('Could not create directory at: ', args.output,
							 ' check that a directory with the same name doesn\'t already exist or that the parent directory exists.')
